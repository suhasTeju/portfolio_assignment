(function($) {
    ...
    if($('#revenue-map').length) {
      ...
      var pdfDisplay = document.getElementById("displayPdf");
      var pdfButton = document.getElementById("pdfBtn");

      var excelDisplay = document.getElementById("displayExcel");
      var excelButton = document.getElementById("excelBtn");

      var graphDisplay = document.getElementById("displayGraph");
      ...
      pdfButton.addEventListener("click", function(){
        ...
        excelDisplay.style.display="none";
